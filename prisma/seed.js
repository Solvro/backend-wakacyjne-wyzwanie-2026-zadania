...
var adapter = new adapter_pg_1.PrismaPg({ connectionString: "postgresql://postgres:28302007@localhost:5432/trip?schema=public" });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    // Clean up existing data in reverse order of foreign key dependencies
                    _a.sent();
                    return [4 /*yield*/, prisma.participant.deleteMany()];
                case 2:
                    _a.sent();
