...
let TripParticipantsModule = class TripParticipantsModule {
};
TripParticipantsModule = __decorate([
    Module({
        controllers: [TripParticipantsController],
        providers: [TripParticipantsService],
    })
], TripParticipantsModule);
export { TripParticipantsModule };
//# sourceMappingURL=trip_participants.module.js.map