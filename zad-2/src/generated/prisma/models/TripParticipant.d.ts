...
export type GetTripParticipantAggregateType<T extends TripParticipantAggregateArgs> = {
    [P in keyof T & keyof AggregateTripParticipant]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateTripParticipant[P]> : Prisma.GetScalarType<T[P], AggregateTripParticipant[P]>;
};
...
export type GetTripParticipantGroupByPayload<T extends TripParticipantGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<TripParticipantGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof TripParticipantGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], TripParticipantGroupByOutputType[P]> : Prisma.GetScalarType<T[P], TripParticipantGroupByOutputType[P]>;
}>>;
...
export type TripParticipantCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<TripParticipantFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TripParticipantDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['TripParticipant'];
        meta: {
            name: 'TripParticipant';
        };
    };
     ...
     * })
    **/
    count<T extends TripParticipantCountArgs>(args?: Prisma.Subset<T, TripParticipantCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], TripParticipantCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends TripParticipantGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, TripParticipantGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTripParticipantGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
