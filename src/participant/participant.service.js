...
var ParticipantsService = /** @class */ (function () {
    ...
    ParticipantsService.prototype.create = function (dto) {
    ...
    ParticipantsService.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.participant.findUnique({ where: { id: id } })];
                    case 1:
                        participant = _a.sent();
                        if (!participant)
                            throw new common_1.NotFoundException("Participant with ID ".concat(id, " not found"));
                        return [2 /*return*/, participant];
                }
            });
        });
    };
    ParticipantsService.prototype.update = function (id, dto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.prisma.participant.update({ where: { id: id }, data: dto })];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.prisma.participant.delete({ where: { id: id } })];
                }
            });
        });
    };
